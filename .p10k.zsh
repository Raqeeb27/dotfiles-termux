# Generated by Powerlevel10k configuration wizard on 2024-07-01 at 22:16 IST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 12h time, slanted separators, round heads, slanted tails, 2 lines, dotted, full frame,
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=46 # 232
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=21 #7
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=226  #2
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=41  #0

  # Status when some part of a pipe command fails but the overall exit status is zero. It may look
  # like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_VISUAL_IDENTIFIER_EXPANSION='✔'
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=226  #2
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND=41  #0

  # Status when it's just an error code (e.g., '1'). No need to show it if prompt_char is enabled as
  # it will signify error by turning red.
  typeset -g POWERLEVEL9K_STATUS_ERROR=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_VISUAL_IDENTIFIER_EXPANSION='✘'
  typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND=229 #3
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND=160 #1
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_FOREGROUND=229  #3
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_BACKGROUND=160  #1

  # Status when some part of a pipe command fails and the overall exit status is also non-zero.
  # It may look like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_VISUAL_IDENTIFIER_EXPANSION='✘'
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_FOREGROUND=229  #3
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND=160  #1

  ###################[ command_execution_time: duration of the last command ]###################
  # Execution time color.
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=255  #0
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=125   #3
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=0  #0
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=3  #7
